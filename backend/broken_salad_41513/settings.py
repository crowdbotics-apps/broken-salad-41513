"""
Django settings for broken_salad_41513 project.
...
ROOT_URLCONF = 'broken_salad_41513.urls'
...
WSGI_APPLICATION = 'broken_salad_41513.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_salad_41513 API",
    "DESCRIPTION": "API documentation for broken_salad_41513 App",
    "VERSION": "v1",
}
